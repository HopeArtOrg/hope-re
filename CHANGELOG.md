...
- Fix ORT input mapping for multi-input models by switching from positional to named tensor inputs
- Fix 'Invalid input name: input' error by using correct ONNX model input name 'images' for image data instead of 'input'
